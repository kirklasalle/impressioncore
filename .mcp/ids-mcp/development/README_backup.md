# Enhanced ImpressionCore IDS MCP Server v2.0.0

**Created:** October-15-2024  
**Updated:** August-04-2025  
**Author:** ImpressionCore Team  
**Tags:** #.mcp\ids_mcp\development\readme_backup.md #api #command_line #documentation #memory_management #security #testing  
**Category:** Documentation  
**Status:** Active

The **Enhanced ImpressionCore Documentation System (IDS) Model Context Protocol Server** provides 17 comprehensive tools for managing, searching, and maintaining the ImpressionCore documentation ecosystem.

## 🚀 Features

### 📚 Original 5 Core Tools (Enhanced)
- **ids_search**: Enhanced search with analytics logging
- **ids_get_file_info**: Detailed file information with metadata
- **ids_list_tags**: Tag listing with advanced filtering
- **ids_get_system_status**: Comprehensive system metrics
- **ids_find_by_tag**: Tag-based file discovery

### 🔧 Index Management Tools (3 New)
- **ids_rebuild_indexes**: Complete documentation reindexing
- **ids_check_index_freshness**: Index staleness detection
- **ids_incremental_update**: Selective file/directory updates

### 🧠 Advanced Search Tools (3 New)
- **ids_semantic_search**: Enhanced semantic search with relevance scoring
- **ids_search_with_context**: Content preview with context around matches
- **ids_search_analytics**: Search usage analytics and trends

### 📋 Documentation Management (3 New)
- **ids_validate_documentation**: Integrity validation (links, tags, orphans)
- **ids_generate_documentation_report**: Comprehensive coverage reports
- **ids_export_index**: Multi-format index data export

### 🔖 Bookmark System Tools (3 New)
- **ids_create_bookmark**: Create categorized bookmarks with triggers
- **ids_manage_bookmarks**: List, update, delete, and complete bookmarks
- **ids_bookmark_analytics**: Bookmark usage statistics and trends

## 📁 Project Structure

```
.mcp/ids-mcp/
├── server.py                     # Original 5-tool MCP server
├── server_enhanced.py             # Intermediate enhanced version
├── server_enhanced_v2.py          # Complete 17-tool implementation
├── test_enhanced_server.py        # Comprehensive test suite
├── README.md                      # This documentation
└── ids_mcp_enhanced.log          # Server operation logs
```
   ```bash
