...
- [Memory-Efficient Attention Documentation](/docs/MEMORY_EFFICIENT_ATTENTION.md)
- [VRAM Optimization Guide](/docs/GPU_MEMORY_MANAGEMENT.md)
- [Model Visualization Best Practices](/docs/VISUALIZATION_BEST_PRACTICES.md)
- [Hardware Target Specifications](/docs/HARDWARE_TARGET.md)

For detailed implementation examples, see the following files:
- `src/examples/visualization_examples.py`
- `src/examples/memory_optimization_example.py`
