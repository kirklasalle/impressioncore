...
| Dimension                  | IC-B3  | IC-B3 Maturity                                         | LLaVA  | Flamingo | GPT-4V | Qwen-VL | InternVL | CogVLM |
| -------------------------- | ------ | ------------------------------------------------------ | ------ | -------- | ------ | ------- | -------- | ------ |
| Dual-system topology       | ★★★    | ✅ Validated                                           | ★      | ★        | ★★     | ★       | ★        | ★      |
| Multimodal fusion depth    | ★★★    | 🟡 Text+Image+Audio only                               | ★★     | ★★       | ★★     | ★★      | ★★★      | ★★     |
| Deliberative reasoning     | ★★★    | 🟡 Code-real; hemispheric specialization pending       | ★      | ★        | ★      | ★       | ★        | ★      |
| Consumer hardware doctrine | ★★★    | ✅ Validated                                           | ★★     | ★        | ★      | ★★      | ★★       | ★      |
| Expert routing             | ★★★    | ✅ Validated                                           | ★      | ★        | ★★★    | ★       | ★★       | ★      |
| Vector retrieval + memory  | ★★★    | ✅ External RAG validated; model-internal aspirational | ★      | ★        | ★      | ★       | ★        | ★      |
| Phased training curriculum | ★★★    | 🟡 Documented; Phase 1 in progress                     | ★★     | ★        | ★      | ★★      | ★★       | ★★     |
| Deployment architecture    | ★★★    | 🔴 Export unimplemented (0 bytes)                      | ★★     | ★        | ★★★    | ★★      | ★★       | ★★     |
| Documentation governance   | ★★★    | ✅ Validated                                           | ★      | ★        | ★★     | ★       | ★        | ★      |
| Modality coverage (native) | ★★★    | 🟡 3/5 modalities implemented                          | ★★     | ★★       | ★★★    | ★★      | ★★       | ★★     |
| **Structural ★ score**     | **30** | —                                                      | **13** | **10**   | **20** | **13**  | **16**   | **12** |

> **Note:** The ★ scoring is a **structural specification completeness** measure, not a performance benchmark or an implementation validation. The "IC-B3 Maturity" column adds an honest assessment of implementation depth as of April 2026. Structural ratings reflect architectural specification richness; maturity ratings reflect source-code-verified implementation status. External reviewers should cite both columns when positioning IC-B3.
