...
class MVPTrainingBootstrap:
    ...
    def create_simple_dataset_loader(self, config: Dict) -> str:
        ...
        # Create the dataset loader content
...
if __name__ == "__main__":
    ...
    config_path = "src/data/output/mvp_training_config_latest.json"
    try:
...
def main():
    ...
    try:
        config_path, launcher_path = bootstrap.run_bootstrap()
        
        if config_path and launcher_path:
            if RICH_AVAILABLE:
