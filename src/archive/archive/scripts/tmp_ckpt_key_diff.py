...
def main():
    ...
    try:
        ...
        try:
            ...
            B3Config = getattr(impmod, 'B3Config')
            ImpressionCoreB3Model = getattr(impmod, 'ImpressionCoreB3Model')
    ...
    print('Summary: ckpt_keys=%d local_keys=%d shared=%d only_in_ckpt=%d only_in_local=%d mismatches=%d missing=%d unexpected=%d' % (
