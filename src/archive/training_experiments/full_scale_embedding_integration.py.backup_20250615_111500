...
class FullScaleEmbeddingIntegrator:
    ...
    def __init__(self, config):
        ...
        # F: drive paths
        self.f_embeddings_dir = Path("F:/embeddings")
    ...
    def _determine_modality(self, filename: str) -> str:
        ...
        modality_keywords = {
            'text': ['text', 'nlp', 'language', 'conversation', 'dialogue', 'transcript'],
...
def main():
    ...
    from src.training.impressioncore_b1_ultimate_trainer import ImpressionCoreB1TestConfig
