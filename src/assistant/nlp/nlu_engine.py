"""
Natural Language Understanding (NLU) Engine for ImpressionCore Personal Assistant

This module implements advanced natural language understanding capabilities
optimized for GTX 1050 Ti hardware constraints (20MB memory budget).
