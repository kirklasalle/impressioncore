...
def quantize_model(model: nn.Module, quantization_level: str = "dynamic") -> nn.Module:
    ...
    try:
        ...
        from src.core.utils.memory_optimization.quantization import optimize_model_with_quantization
        ...
        if quantization_level == "dynamic":
            ...
            raise NotImplementedError("Static quantization requires calibration data. Use the enhanced quantization module for full support.")
            ...
            raise NotImplementedError("Quantization-aware training is available in src.core.utils.memory_optimization.quantization module.")
        return model
