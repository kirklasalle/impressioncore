...
def check_server_health():
    ...
    try:
        ...
        # Optionally, check for required attributes/routes
        assert hasattr(server, 'app'), "Flask app instance 'app' not found in server.py"
        assert hasattr(server, 'load_model'), "Function 'load_model' not found in server.py"
        assert hasattr(server, 'get_model_metadata'), "Function 'get_model_metadata' not found in server.py"
